...
const hulls: HullExpectation[] = [
    {
        ...
        chainGuns: [{ direction: 'FWD', bps: 8, maxRange: 4500, minRange: 500, bulletSpeed: 1000, bearingLimit: 0 }],
    ...
    },
    {
        ...
        thrusters: 4,
        thrusterCapacity: 300,
        chainGuns: [{ direction: 'FWD', bps: 14, maxRange: 4500, minRange: 500, bulletSpeed: 1000, bearingLimit: 0 }],
    ...
    },
    {
        ...
        thrusters: 6,
        thrusterCapacity: 300,
        chainGuns: [{ direction: 'FWD', bps: 30, maxRange: 8_000, minRange: 500, bulletSpeed: 2_000, bearingLimit: 0 }],
    ...
    },
    {
        ...
        chainGuns: [{ direction: 'FWD', bps: 30, maxRange: 7_500, minRange: 500, bulletSpeed: 2_000, bearingLimit: 0 }],
        shells: { HiExpShell: 3_600, ArmPenShell: 1_800, FragShell: 3_000 },
        tubes: 2,
