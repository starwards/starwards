...
export function gunWidget(shipDriver: ShipDriver): DashboardWidget {
    class GunComponent {
        constructor(container: WidgetContainer, _: unknown) {
            ...
            chainGunPanel.addProperty('max Ammo', readNumberProp(shipDriver, `/magazine/count_CannonHe`));
            chainGunPanel.addProperty('ammo', readNumberProp(shipDriver, `/magazine/count_CannonHe`));
