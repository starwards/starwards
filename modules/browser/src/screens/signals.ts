...
import { Driver, Radar, ShipDriver, SpaceDriver, Status, scanCycleTargets } from '@starwards/core';
...
const { statusTracker, getAssignedShipId } = registerStationClient(driver, 'signals', requestedShipId);
