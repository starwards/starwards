...
Candidate gap-closing moves and the proposed build order have been extracted to [`proposals.md`](proposals.md). Confirmed decisions live in [`decisions.md`](decisions.md). This file holds the analysis only.
