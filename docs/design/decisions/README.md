...
Key product decisions and their rationale. Not every choice needs a record — only decisions that are surprising, contested, or that future contributors might question.

## Decision Log

| # | Decision | Date | Doc |
|---|----------|------|-----|
| 1 | Build from scratch instead of extending EmptyEpsilon | 2021-01 | [001-rebuild-from-scratch.md](001-rebuild-from-scratch.md) |
| 2 | Remove 3D main screen view | 2024-03 | [002-remove-3d-view.md](002-remove-3d-view.md) |
...
| 13 | ShipRooms for NPC ships, so the GM tweak panel can reach ShipState | 2026-03 | [013-npc-ship-rooms.md](013-npc-ship-rooms.md) |
| 14 | `@commandable()` is accidental-exposure protection, not adversarial containment | 2026-08 | [014-commandable-is-not-containment.md](014-commandable-is-not-containment.md) |

## Template

See [TEMPLATE.md](TEMPLATE.md) for the format when adding new decisions.
