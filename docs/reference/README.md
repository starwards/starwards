# Reference — external & vendor material

Captured documentation for third-party tools and frameworks. **Verify against upstream before
relying on it** — these are point-in-time captures, not maintained by this project, and they are
excluded from the docs staleness sweep.

Nothing here describes Starwards' own behaviour; for that, see the [docs index](../README.md).
...
| [`CHANGES_SINCE_BLOG.md`](CHANGES_SINCE_BLOG.md) | Changes made after that blog summary. |
| `pixijs/llms*.txt` | PixiJS LLM-oriented API dumps (large; not linked into the docs graph). |
