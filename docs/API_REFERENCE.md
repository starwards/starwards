...
| Thruster | `thruster.ts` | bearing, active, availableCapacity | getVelocityCapacity() |
...
| Tube | `tube.ts` | index (extends ChainGun/Turret: bearing, isFiring, loadAmmo, loading, loadedProjectile) | (none; firing/loading handled by chain-gun-manager) |
